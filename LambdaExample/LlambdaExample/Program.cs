...
namespace LlambdaExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("\n\nYes, A person having a FirstName  'Joe'  exists in tthis list");
            }
            ...
            List<Employee> newList = joeList.Where(x => x.FirstName == "Joe").ToList();//new list with Joe as first name (lambda version)
            foreach (Employee cPart in newList)
            {
                Console.WriteLine(cPart.FirstName+"   "+cPart.eNumber);//lists out results of joeList in the form newList
            }
        }
